...
@section('content')
		...
		<div class="main-error-wrapper  page page-h ">
			...
			<h2>أوبس. الصفحة التي تبحث عنها غير موجودة.</h2>
			<h6>بما أخطأت في كتابة العنوان أو ربما تم نقل الصفحة.</h6><a class="btn btn-outline-danger" href="{{ url('/') }}">العودة إلى الرئيسية</a>
		</div>
		<!-- /Main-error-wrapper -->
@endsection
@section('js')
