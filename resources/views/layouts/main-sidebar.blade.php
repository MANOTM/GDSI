<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
				<a class="desktop-logo logo-light active" href="{{ url('/') }}"><img class="main-logo" src="{{asset('assets/img/brand/logo.png')}}" alt=""></a>
				<a class="desktop-logo logo-dark active" href="{{ url('/') }}"><img class="main-logo dark-theme" src="{{asset('assets/img/brand/logo.png')}}" alt=""></a>
				...
				<a class="logo-icon mobile-logo icon-dark active" href="{{ url('/') }}"><img src="{{URL::asset('assets/img/brand/logo.png')}}" class="logo-icon dark-theme" alt="logo"></a>
			</div>
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							@if (auth()->user()->avatar)
								<img class="avatar avatar-xl brround"  src="/avatars/{{auth()->user()->avatar}}">
							@else
								<img class="avatar avatar-xl brround"  src="{{URL::asset('assets/img/faces/user.png')}}">
							@endif
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu"> 
							<li><a class="slide-item" href="{{ url('/' . $page='etablissement/create') }}">اضفة مؤسسة</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='employer/create') }}">اضافة مستفيذ</a></li> 
						</ul>
					</li>
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M6 20h12V10H6v10zm6-7c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2z" opacity=".3"/><path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zM9 6c0-1.66 1.34-3 3-3s3 1.34 3 3v2H9V6zm9 14H6V10h12v10zm-6-3c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2z"/></svg><span class="side-menu__label">الحساب</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							{{-- <li><a class="slide-item" href="{{ url('/marche/create') }}">الحساب الشخصي</a></li> --}}
							<li><a class="slide-item" href="{{route('profile')}}">تعديل الحساب</a></li>
							<li><a class="slide-item" href="{{ route('logout') }}">تسجيل الخروج</a></li>
						</ul>
					</li>
